...
class CrmController extends ChangeNotifier {
  ...
  /// Updates the follow-up schedule date of a lead in Supabase
  Future<void> updateLeadSchedule(int id, DateTime newDate) async {
    try {
      // Format to ISO 8601 string (or YYYY-MM-DD depending on your database column type)
      ...
      await fetchLeads(); // Refresh leads to update UI
    } catch (e) {
