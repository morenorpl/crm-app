...
class _DashboardScreenState extends State<DashboardScreen> {
                        ...
                        child: Row(
                          children: [
                            ...
                            _buildFilterChip(
                              ...
                              () => setState(() => _selectedTeamFilter = 'Kinerja Ku Saja'),
                              activeColor: const Color(0xFF3B82F6),
                            ),
                          ],
                        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('Max (1)', style: TextStyle(color: Colors.white.withOpacity(0.4), fontSize: 10)),
          const SizedBox(height: 12),
          ...
          Row(
            children: [
              ...
              const Text('Hari ini', style: TextStyle(color: Color(0xFFA197B4), fontSize: 10)),
              const Spacer(),
              Expanded(
                flex: 4,
                child: Text(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            icon: const Text('Buka Board Crm', style: TextStyle(color: Colors.white, fontSize: 11)),
            label: const Icon(Icons.north_east_rounded, size: 12, color: Colors.white),
          ),
          const SizedBox(height: 14),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 8),
                _buildDropdownFilter(Icons.people_outline_rounded, 'Semua Tipe (Output)'),
                const SizedBox(height: 12),
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('Ekspor CSV', style: TextStyle(color: Colors.white, fontSize: 12)),
                ),
                const SizedBox(height: 8),
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('Tambah Prospek Baru', style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
          ),
  ...
  Widget _buildSearchInput() {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.search_rounded, size: 16, color: Colors.white.withOpacity(0.4)),
